...
public abstract class AbstractCardCollection {
     ...
     * 
     * Two collections are equal if they contain the same cards (order doesn't matter)
     * and they have the same maximum amount of cards.
     * 
     * @param obj
     * @return 
     */
    ...
    public boolean equals(Object obj) {
        ...
        // We add cards to a set, because the order doesn't matter here.
        Set<Card> thisCards = new HashSet<Card>(this.cards);
        Set<Card> otherCards = new HashSet<Card>(other.cards);
        
        if (!thisCards.equals(otherCards)) {
            return false;
        }
